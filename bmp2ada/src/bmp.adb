...
package body BMP is
   ...
   begin
      ...
      Text_IO.Put_Line (File_Out, "with Giza.Colors; use Giza.Colors;");
      Text_IO.New_Line (File_Out);
      Text_IO.Put_Line (File_Out, "package " & Package_Name & " is");
      Text_IO.New_Line (File_Out);
      Text_IO.Put (File_Out, "   Data : ");

      case Info.Pixel_Size is
         when 1 =>
            Text_IO.Put (File_Out, "Bitmap_Indexed_1bit");
         when 2 =>
            Text_IO.Put (File_Out, "Bitmap_Indexed_2bits");
         when 4 =>
            Text_IO.Put (File_Out, "Bitmap_Indexed_4bits");
         when 8 =>
            Text_IO.Put (File_Out, "Bitmap_Indexed_8bits");
         when others =>
            raise Program_Error;
      end case;
      ...
      for Row_Cnt in reverse 0 .. Integer (Info.Height) - 1 loop
         ...
         for Index in 0 .. Integer (Info.Width - 1) loop
            ...
            case Info.Pixel_Size is
               when 1 =>
                  Palette_Index :=
                    Unsigned_8 (Pix_Values (Byte_Index).P1 (Pix_Index));
               when 2 =>
                  Palette_Index :=
