...
package body BMP is
   ...
   begin
      ...
      Text_IO.Put_Line (File_Out, "with Giza.Images.Bitmap.Indexed_" &
                          Size_Str & "_Image;");
      ...
      Text_IO.Put_Line (File_Out, "   aliased Giza.Images.Bitmap.Indexed_" &
                          Size_Str & "_Image.Bitmap_Indexed_Image");
